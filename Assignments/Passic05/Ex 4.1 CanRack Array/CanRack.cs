...
namespace Exercise_04._1_CanRack_Array
{
    ...
    class CanRack
    {
        ...
        public void AddACanOf(string FlavorOfCanToBeAdded)
        {
            ...
            {
                Debug.WriteLine("*** Failed attempt to add a can of {0} to a full rack", 
        ...
        public void RemoveACanOf(string FlavorOfCanToBeRemoved)
        {
            ...
            {
                Console.WriteLine("*** Failed attempt to remove a can of {0} from an empty rack", FlavorOfCanToBeRemoved);
            }
            else
            {
                // convert the string Flavor into the appropriate int value
                ...
                if (Enum.IsDefined(typeof(Flavor), FlavorOfCanToBeRemoved))
                {
                    ...
                    Console.WriteLine("removing a can of {0} flavored soda from the rack", FlavorOfCanToBeRemoved);
                    int flavorIndex = (int)flavorEnumeral;
                    rack[flavorIndex]--;
                }
                else
